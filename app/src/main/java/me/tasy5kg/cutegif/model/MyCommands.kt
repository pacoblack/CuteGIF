...
object MyCommands {
  ...
  fun COMMAND_CHECK_STABLE(extractedVideoPath:String):String{
  ...
  fun COMMAND_TRANSFORM_VIDEO(extractedVideoPath:String, extractedVideoStabilizedPath: String):String{
  ...
  fun COMMAND_COLOR_FILTER(colorKey:Pair<String, Int>?, catchShortLength: String?, catchShortLengthColorKey: String?):String{
    var command = ""
    colorKey?.let {
  ...
  fun COMMAND_GENERATE_PALETTE(catchShortLengthColorKey: String?, colorQuality:String, catchShortLengthColorKeyPalettegen: String?):String{
  ...
  fun COMMAND_USE_PALETTE(catchShortLengthColorKey: String?, catchShortLengthColorKeyPalettegen: String?,catchShortLengthColorKeyPaletteuse: String?):String{
  ...
  fun COMMAND_TO_VIDEO(inputVideoPath:String, fallbackMp4Path:String):String{
